...
with app.app_context():
    ...
    project2 = Project(name="SweatSpectrum",type="Lifestyle",image="https://cdn4.iconfinder.com/data/icons/logos-and-brands/512/116_Ethereum_logo_logos-512.png", description="""
