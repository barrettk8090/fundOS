...
function UserFundedCard({oneFundedProject}){
    ...
    return (
       <>
            ...
            <h2 className="col-span-1  border-b-2 py-8">$ {oneFundedProject.funding_needed}</h2>
            <h2 className="col-span-1 border-b-2 py-8">${oneFundedProject.current_funding}</h2>
            <h2 className="col-span-1 border-b-2 py-8">{oneFundedProject.deadline.split(' ')[0]}</h2>
            <h2 className="col-span-1 border-b-2 py-8">$ {oneFundedProject.user_funded_amount}</h2>
