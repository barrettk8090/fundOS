...
<ellipse cx="130.5" cy="125" rx="130.5" ry="125" fill="url(#paint1_radial_31_8)" fill-opacity="0.4"/>
<circle cx="130" cy="125" r="95" stroke="#572794" stroke-width="6"/>
<path d="M80.6665 118.834L130 131.167L179.333 118.833M80.6665 118.834L130 63.3334M80.6665 118.834L130 106.501M179.333 118.833L130 63.3334M179.333 118.833L130 106.501M130 63.3334V106.501M89.9165 143.5L130 186.667L170.083 143.5L130 152.75L89.9165 143.5Z" stroke="#572794" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<defs>
<linearGradient id="paint0_linear_31_8" x1="484.5" y1="49" x2="484.5" y2="202" gradientUnits="userSpaceOnUse">
<stop stop-color="#572794"/>
<stop offset="1" stop-color="#C917C2" stop-opacity="0.6"/>
</linearGradient>
...
<stop offset="0.0001" stop-color="#0066FF"/>
<stop offset="1" stop-color="#FF00F5" stop-opacity="0"/>
</radialGradient>
</defs>
                </svg></Link>
            
                <Link to="/create-new-project"><li className="mx-4"><button>Start A Project +</button></li></Link>
                <li className="mx-4 p-4 bg-pink-600">WalletConnect</li>
